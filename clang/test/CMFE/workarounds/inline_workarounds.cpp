...
// RUN: %cmc -march=SKL -fcmocl -Xclang -disable-llvm-passes -S -emit-llvm  -o %t.ll -- %s
...
// RUN: %cmc -cm_disable_strong_inline -D__DISABLE_CM_PRINT_INLINE_WA -march=SKL -fcmocl -Xclang -disable-llvm-passes -S -emit-llvm  -o %t.ll -- %s
...
// RUN: %cmc -cm_disable_strong_inline -D__DISABLE_SPIRV_WRITER_INLINE_WA -march=SKL -fcmocl -Xclang -disable-llvm-passes -S -emit-llvm  -o %t.ll -- %s
