...
void test_bti(SurfaceIndex In, unsigned Offset) {
  ...
  auto x = cm_load<T, 4, DS>(In, Offset);
  (void)x;
}
...
_GENX_MAIN_ void bad_load_bti_u8(SurfaceIndex In, unsigned Offset) {
...
// CHECK: error: Transposed load can work only with U32 and U64 data sizes
_GENX_MAIN_ void bad_load_bti_u16(SurfaceIndex In, unsigned Offset) {
...
// CHECK: error: Transposed load can work only with U32 and U64 data sizes
_GENX_MAIN_ void bad_load_bti_u8u32(SurfaceIndex In, unsigned Offset) {
...
// CHECK: error: Transposed load can work only with U32 and U64 data sizes
_GENX_MAIN_ void bad_load_bti_u16u32(SurfaceIndex In, unsigned Offset) {
...
// CHECK: error: Transposed load can work only with U32 and U64 data sizes
_GENX_MAIN_ void bad_load_bti_u16u32h(SurfaceIndex In, unsigned Offset) {
