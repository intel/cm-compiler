...
enum CMBuiltinKind {
  ...
  CMBK_cm_qf_cvt_impl,
  CMBK_cm_hf8_cvt,
  CMBK_cm_hf8_cvt_impl,
  CMBK_cm_tf32_cvt,
  CMBK_cm_tf32_cvt_impl,
  CMBK_cm_srnd,
  CMBK_cm_srnd_impl,
  CMBK_cm_srnd_bf8_impl,
  CMBK_cm_srnd_hf8_impl,
  ...
  CMBK_gather_impl,
  CMBK_scatter_impl,
  CMBK_gather_svm_impl,
  CMBK_scatter_svm_impl,
