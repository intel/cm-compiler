...
enum class CmBlockScaleType {
  E8M0 = 0,
};

#define CM_BLOCK_SCALE_E8M0 CmBlockScaleType::E8M0

constexpr int BDpasScaleBlockSize(CmBlockScaleType ScaleTy) {
  return 32;
}

template <CmPrecisionType Src1Ty, CmPrecisionType Src2Ty,
          CmBlockScaleType ScaleTy, int SystolicDepth, int RepeatCount,
          typename ResTy, typename AccTy, typename T1, typename T2, int AccSize,
...
CM_NODEBUG CM_INLINE void bdpas_check_common() {
  ...
  CM_HAS_BDPAS_CONTROL;
    ...
    CM_STATIC_ERROR(RepeatCount == 8,
                    "Invalid repeat count for BDPAS operation");
    ...
    CM_STATIC_ERROR(Src1Size ==
                        get_dpas_src1_size(Src1Ty, Src2Ty, SystolicDepth),
...
constexpr uint8_t BDpasNullScaleValue(CmBlockScaleType ScaleTy) {
  return 127;
}

constexpr int get_bdpas_src1_scale_size(int SystolicDepth,
                                        CmPrecisionType Src1Ty,
                                        CmBlockScaleType ScaleTy) {
  ...
  auto ScaleSize = KDimension / BDpasScaleBlockSize(ScaleTy);
  if (ScaleSize < 1)
    ScaleSize = 1;
...
using BDpasSrc1ScaleType =
    vector<uint8_t,
           get_bdpas_src1_scale_size(SystolicDepth, Src1Precision, ScaleTy)>;
...
template <CmPrecisionType Src1Precision, CmPrecisionType Src2Precision,
          ...
          int Src2Size, CmBlockScaleType ScaleTy = CM_BLOCK_SCALE_E8M0>
vector<ResTy, AccSize> __cm_intrinsic_impl_bdpas(
    ...
    BDpasSrc1ScaleType<SystolicDepth, Src1Precision, ScaleTy> Src1Scale,
    BDpasSrc2ScaleType<SystolicDepth, RepeatCount, Src2Precision, ScaleTy>
        Src2Scale);
} // namespace details

using CmBlockScaleType = details::CmBlockScaleType;
...
cm_bdpas(vector<AccTy, AccSize> Acc, vector<Src1Ty, Src1Size> Src1,
         vector<Src2Ty, Src2Size> Src2,
         details::BDpasSrc1ScaleType<SystolicDepth, Src1Precision, ScaleTy>
             Src1Scale,
         details::BDpasSrc2ScaleType<SystolicDepth, RepeatCount, Src2Precision,
                                     ScaleTy>
             Src2Scale) {
  details::bdpas_check_common<Src1Precision, Src2Precision,
                              ScaleTy, SystolicDepth, RepeatCount, ResTy, AccTy,
                              Src1Ty, Src2Ty, AccSize, Src1Size, Src2Size>();

  return details::__cm_intrinsic_impl_bdpas<
      Src1Precision, Src2Precision, SystolicDepth, RepeatCount, ResTy, AccTy,
      Src1Ty, Src2Ty, AccSize, Src1Size, Src2Size, ScaleTy>(
...
cm_bdpas(vector<AccTy, AccSize> Acc, vector<Src1Ty, Src1Size> Src1,
  ...
  return cm_bdpas<Src1Precision, Src2Precision, SystolicDepth, RepeatCount,
                  ...
                  ScaleTy>(Acc, Src1, Src2, Src1Scale, Src2Scale);
}
...
cm_bdpas(vector<AccTy, AccSize> Acc, vector<Src1Ty, Src1Size> Src1,
  ...
  details::BDpasSrc1ScaleType<SystolicDepth, Src1Precision, ScaleTy> Src1Scale =
      details::BDpasNullScaleValue(ScaleTy);
...
cm_bdpas(vector<AccTy, AccSize> Acc, vector<Src1Ty, Src1Size> Src1,
  ...
  return cm_bdpas<Src1Precision, Src2Precision, SystolicDepth, RepeatCount,
                  AccTy, AccTy, Src1Ty, Src2Ty, AccSize, Src1Size, Src2Size,
                  ScaleTy>(Acc, Src1, Src2, NullSrc1Scale, Src2Scale);
}
...
cm_bdpas(vector<AccTy, AccSize> Acc, vector<Src1Ty, Src1Size> Src1,
  ...
  details::BDpasSrc2ScaleType<SystolicDepth, RepeatCount, Src2Precision,
                              ScaleTy>
      Src2Scale = details::BDpasNullScaleValue(ScaleTy);
...
cm_bdpas(vector<AccTy, AccSize> Acc, vector<Src1Ty, Src1Size> Src1,
  ...
  return cm_bdpas<Src1Precision, Src2Precision, SystolicDepth, RepeatCount,
                  AccTy, AccTy, Src1Ty, Src2Ty, AccSize, Src1Size, Src2Size,
                  ScaleTy>(Acc, Src1, Src2, Src1Scale, NullSrc2Scale);
}
...
// Backward-compatible convenience overloads that allow
// passing ScaleTy as the 6th explicitly specified
// template argument: cm_bdpas<S1, S2, SD, RC, ResTy,
// ScaleTy>(...)
template <CmPrecisionType Src1Precision, CmPrecisionType Src2Precision,
          int SystolicDepth, int RepeatCount, typename ResTy,
          CmBlockScaleType ScaleTy, typename AccTy, typename Src1Ty,
          typename Src2Ty, int AccSize, int Src1Size, int Src2Size>
CM_NODEBUG CM_INLINE vector<ResTy, AccSize>
cm_bdpas(vector<AccTy, AccSize> Acc, vector<Src1Ty, Src1Size> Src1,
         vector<Src2Ty, Src2Size> Src2,
...
template <CmPrecisionType Src1Precision, CmPrecisionType Src2Precision,
          int SystolicDepth, int RepeatCount, typename ResTy,
          CmBlockScaleType ScaleTy, typename Src1Ty, typename Src2Ty,
          int AccSize = details::get_dpas_acc_size(RepeatCount, Src1Precision),
          int Src1Size = details::get_dpas_src1_size(
              Src1Precision, Src2Precision, SystolicDepth),
          int Src2Size = details::get_dpas_src2_size(
...
cm_bdpas(int Null, vector<Src1Ty, Src1Size> Src1, vector<Src2Ty, Src2Size> Src2,
         ...
         details::BDpasSrc2ScaleType<SystolicDepth, RepeatCount, Src2Precision,
             ...
             Src2Scale) {
  return cm_bdpas<Src1Precision, Src2Precision, SystolicDepth, RepeatCount,
                  ResTy, Src1Ty, Src2Ty, AccSize, Src1Size, Src2Size, ScaleTy>(
      Null, Src1, Src2, Src1Scale, Src2Scale);
}
...
cm_bdpas(int Null, vector<Src1Ty, Src1Size> Src1, vector<Src2Ty, Src2Size> Src2,
  ...
  return cm_bdpas<Src1Precision, Src2Precision, SystolicDepth, RepeatCount,
                  ResTy, Src1Ty, Src2Ty, AccSize, Src1Size, Src2Size, ScaleTy>(
      Null, Src1, Src2, NullSrc1Scale, Src2Scale);
}
...
cm_bdpas(int Null, vector<Src1Ty, Src1Size> Src1, vector<Src2Ty, Src2Size> Src2,
  ...
  return cm_bdpas<Src1Precision, Src2Precision, SystolicDepth, RepeatCount,
                  ResTy, Src1Ty, Src2Ty, AccSize, Src1Size, Src2Size, ScaleTy>(
      Null, Src1, Src2, Src1Scale, NullSrc2Scale);
}
