...
TypeDependence CMVectorTypeCommon::calcDependencies(QualType ElementType) {
  TypeDependence Deps = TypeDependence::None;
  if (ElementType->isDependentType())
    Deps |= TypeDependence::Dependent;
  if (ElementType->isInstantiationDependentType())
    Deps |= TypeDependence::Instantiation;
  if (ElementType->isVariablyModifiedType())
    Deps |= TypeDependence::VariablyModified;
  if (ElementType->containsUnexpandedParameterPack())
...
CMVectorType::CMVectorType(const ASTContext &Context, TypeClass TC,
    ...
    : Type(TC, Can, calcDependencies(ElementType)),
...
DependentCMVectorType::DependentCMVectorType(
  ...
  Deps |= TypeDependence::DependentInstantiation;
