...
// The /Qxcm_no_cr_fix option is ignored
// RUN: %cmc -mCM_old_asm_name /Qxcm_no_cr_fix %w 2>&1 | FileCheck %w 
// RUN: rm %W.isa
...
// CHECK: cm_no_cr_fix_slash.cpp(15,2):  warning: CM_GENX not defined [-W#warnings]
