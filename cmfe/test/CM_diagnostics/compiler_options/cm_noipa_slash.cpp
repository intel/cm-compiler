...
// The /Qxcm_noipa option is ignored
// RUN: %cmc -mCM_old_asm_name /Qxcm_noipa %w 2>&1 | FileCheck %w 
// RUN: rm %W.isa
...
// CHECK: cm_noipa_slash.cpp(15,2):  warning: CM_GENX not defined [-W#warnings]
