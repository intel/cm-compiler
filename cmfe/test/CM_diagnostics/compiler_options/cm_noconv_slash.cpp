...
// The /Qxcm_noconv option is ignored
// RUN: %cmc -mCM_old_asm_name /Qxcm_noconv %w 2>&1 | FileCheck %w 
// RUN: rm %W.isa
...
// CHECK: cm_noconv_slash.cpp(15,2):  warning: CM_GENX not defined [-W#warnings]
