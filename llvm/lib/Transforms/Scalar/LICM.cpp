...
static cl::opt<int>
LICMHoistPressureThreshold("LICM-hoisting-pressure-threshold",
  cl::Hidden, cl::init(2048),
...
static unsigned EstimateLiveOutPressure(BasicBlock *blk, const DataLayout *DL)
{
  unsigned pressure = 0;
...
bool LICM::runOnLoop(Loop *L, LPPassManager &LPM) {
  ...
  if (Preheader) {
    ...
    auto BeforePressure = EstimateLiveOutPressure(Preheader, DL);
    ...
    auto AfterPressure = EstimateLiveOutPressure(Preheader, DL);
