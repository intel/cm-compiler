...
DEFAULT_TYPELOC_IMPL(CMVector, Type)
DEFAULT_TYPELOC_IMPL(CMMatrix, Type)
DEFAULT_TYPELOC_IMPL(DependentCMVector, Type)
DEFAULT_TYPELOC_IMPL(DependentCMMatrix, Type)
