...
QualType ASTReader::GetType(TypeID ID) {
  ...
  if (Index < NUM_PREDEF_TYPE_IDS) {
    ...
    case PREDEF_TYPE_SURFACE_INDEX_ID: T = Context.CMSurfaceIndexTy; break;
    case PREDEF_TYPE_SAMPLER_INDEX_ID: T = Context.CMSamplerIndexTy; break;
    case PREDEF_TYPE_VME_INDEX_ID:     T = Context.CMVmeIndexTy; break;
