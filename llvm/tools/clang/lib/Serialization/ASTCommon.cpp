...
serialization::TypeIdxFromBuiltin(const BuiltinType *BT) {
  ...
  case BuiltinType::CMSurfaceIndex:  ID = PREDEF_TYPE_SURFACE_INDEX_ID; break;
  case BuiltinType::CMSamplerIndex:  ID = PREDEF_TYPE_SAMPLER_INDEX_ID; break;
  case BuiltinType::CMVmeIndex:      ID = PREDEF_TYPE_VME_INDEX_ID;     break;
