...
llvm::Value *CodeGenFunction::EmitLoadOfScalar(llvm::Value *Addr, bool Volatile,
  ...
  if (CGM.getCodeGenOpts().EmitVLoadStore && isa<llvm::Argument>(Addr))
     return CGCMRuntime::EmitCMRefLoad(*this, Addr);
...
void CodeGenFunction::EmitStoreOfScalar(llvm::Value *Value, llvm::Value *Addr,
  ...
  if (CGM.getCodeGenOpts().EmitVLoadStore && isa<llvm::Argument>(Addr)) {
    CGCMRuntime::EmitCMRefStore(*this, Value, Addr);
    return;
  }
...
RValue CodeGenFunction::EmitLoadOfLValue(LValue LV, SourceLocation Loc) {
  ...
  if (LV.isSimple()) {
    ...
    if (LV.isCMArgumentReference())
      return RValue::get(
          CGM.getCMRuntime().EmitCMRefLoad(*this, LV.getAddress()));
