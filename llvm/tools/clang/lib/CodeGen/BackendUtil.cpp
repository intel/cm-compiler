...
static void addCMABIPass(const PassManagerBuilder &Builder,
                         PassManagerBase &PM) {
  PM.add(createCMABIPass());
}

static void addCMImpParamPass(const PassManagerBuilder &Builder,
                              PassManagerBase &PM) {
  PM.add(createCMImpParamPass());
}
