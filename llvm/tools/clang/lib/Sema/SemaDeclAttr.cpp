...
static void handleCMGenxAttr(Sema &S, Decl *D, const AttributeList &Attr){
  assert(!Attr.isInvalid());
  D->addAttr(::new (S.Context) CMGenxAttr(Attr.getRange(), S.Context,
                                Attr.getAttributeSpellingListIndex()));
}
...
static void handleCMGenxStackcallAttr(Sema &S, Decl *D, const AttributeList &Attr){
  assert(!Attr.isInvalid());
  D->addAttr(::new (S.Context) CMGenxStackcallAttr(Attr.getRange(), S.Context,
                                Attr.getAttributeSpellingListIndex()));
}

static void handleCMInputAttr(Sema &S, Decl *D, const AttributeList &Attr) {
  assert(!Attr.isInvalid());
  D->addAttr(::new (S.Context) CMInputAttr(
      Attr.getRange(), S.Context, Attr.getAttributeSpellingListIndex()));
}

static void handleCMOutputAttr(Sema &S, Decl *D, const AttributeList &Attr) {
  assert(!Attr.isInvalid());
...
static void handleCMCallableAttr(Sema &S, Decl *D, const AttributeList &Attr) {
  assert(!Attr.isInvalid());
  D->addAttr(::new (S.Context) CMCallableAttr(Attr.getRange(), S.Context,
                                Attr.getAttributeSpellingListIndex()));
}

static void handleCMFloatControlAttr(Sema &S, Decl *D, const AttributeList &Attr){
  assert(!Attr.isInvalid());
...
static void ProcessDeclAttribute(Sema &S, Scope *scope, Decl *D,
  ...
  case AttributeList::AT_CMGenxMain:
    ...
    break;
  case AttributeList::AT_CMGenxStackcall:
    handleCMGenxStackcallAttr(S, D, Attr);
    break;
  case AttributeList::AT_CMInput:
    handleCMInputAttr(S, D, Attr);
    break;
  case AttributeList::AT_CMOutput:
    handleCMOutputAttr(S, D, Attr);
    break;
  case AttributeList::AT_CMInputOutput:
    handleCMInputOutputAttr(S, D, Attr);
    break;
  case AttributeList::AT_CMCallable:
    handleCMCallableAttr(S, D, Attr);
    break;
