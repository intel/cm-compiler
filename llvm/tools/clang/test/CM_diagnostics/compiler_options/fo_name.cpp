...
// RUN: %cmc -Qxcm_jit_target=cnl -Fofo_name_out %w 2>&1 | FileCheck %w
// RUN: rm fo_name_out.isa %W_0.visaasm %W_0.asm %W_0.dat
...
// CHECK: fo_name.cpp(13,2) :  warning: CM_GENX defined [-W#warnings]
// CHECK: fo_name.cpp(37,2) :  warning: CM_GEN10 defined [-W#warnings]
