...
// RUN: %cmc -Qxcm_jit_target=cnl /Fa=fa_name_slash_out %w 2>&1 | FileCheck %w
// RUN: rm %W.isa fa_name_slash_out_0.visaasm fa_name_slash_out_0.asm fa_name_slash_out_0.dat
...
// CHECK: fa_name_slash.cpp(13,2) :  warning: CM_GENX defined [-W#warnings]
// CHECK: fa_name_slash.cpp(37,2) :  warning: CM_GEN10 defined [-W#warnings]
