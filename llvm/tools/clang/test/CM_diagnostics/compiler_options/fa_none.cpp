...
// RUN: %cmc -Qxcm_jit_target=cnl -Fa %w 2>&1 | FileCheck %w
...
// CHECK: fa_none.cpp(13,2) :  warning: CM_GENX defined [-W#warnings]
// CHECK: fa_none.cpp(37,2) :  warning: CM_GEN10 defined [-W#warnings]
