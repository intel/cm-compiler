...
// RUN: %cmc -Qxcm_jit_target=cnl -Fo=fo_suffix_out.txt %w 2>&1 | FileCheck %w
// RUN: rm fo_suffix_out.isa %W_0.visaasm %W_0.asm %W_0.dat
...
// CHECK: fo_suffix.cpp(14,2) :  warning: CM_GENX defined [-W#warnings]
// CHECK: fo_suffix.cpp(38,2) :  warning: CM_GEN10 defined [-W#warnings]
