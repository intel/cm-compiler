...
// RUN: %cmc -Qxcm_jit_target=skl -Qxcm_asm_output=asm_output %w 2>&1 | FileCheck %w
// RUN: rm %W.isa asm_output_0.visaasm asm_output_0.asm asm_output_0.dat
...
// CHECK: cm_asm_output.cpp(13,2):  warning: CM_GENX defined [-W#warnings]
// CHECK: cm_asm_output.cpp(29,2):  warning: CM_GEN9 defined [-W#warnings]
