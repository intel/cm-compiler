...
// RUN: %cmc -Qxcm_jit_target=cnl -FoOutput/ %w 2>&1 | FileCheck %w
// RUN: rm Output/%W.isa %W_0.visaasm %W_0.asm %W_0.dat
...
// CHECK: fo_dir.cpp(14,2) :  warning: CM_GENX defined [-W#warnings]
// CHECK: fo_dir.cpp(38,2) :  warning: CM_GEN10 defined [-W#warnings]
