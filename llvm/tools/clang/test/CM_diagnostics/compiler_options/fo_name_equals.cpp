...
// RUN: %cmc -Qxcm_jit_target=cnl -Fo=fo_name_equals_out %w 2>&1 | FileCheck %w
// RUN: rm fo_name_equals_out.isa %W_0.visaasm %W_0.asm %W_0.dat
...
// CHECK: fo_name_equals.cpp(13,2) :  warning: CM_GENX defined [-W#warnings]
// CHECK: fo_name_equals.cpp(37,2) :  warning: CM_GEN10 defined [-W#warnings]
