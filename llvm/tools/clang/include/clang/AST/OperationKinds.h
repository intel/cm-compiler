...
enum CastKind {
  ...
  /// CK_CMVectorMatrixSplat - A conversion from an arithmetic type to a
  /// vector of that element type.  Fills all elements ("splats") with
  /// the source value.
  ///    vector<int, 4> v = 5;
  ///    matrix<int, 4, 4> m = 5;
  CK_CMVectorMatrixSplat,

  /// CK_CMBaseToReference - A conversion from base type to a reference type.
  ///
  ///    vector<int, 8> v = 5;
  ///    vector_ref<int, 4> vref = v;
  ///
  CK_CMBaseToReference,

  /// CK_CMReferenceToBase - A conversion from reference type to a base type.
  ///
  ///    vector_ref<int, 8> v1 = v0;
  ///    vector<int, 8> v2 = 5;
  ///    v2 += v1;
  ///
  CK_CMReferenceToBase,
