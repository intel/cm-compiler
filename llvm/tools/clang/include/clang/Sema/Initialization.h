...
public:
  ...
  enum StepKind {
    ...
    /// \brief Initialize a CM vector or matrix from an constant array.
    SK_CMVectorMatrixInit,
    /// \brief Initialize a CM SurfaceIndex from an integer.
    SK_CMSurfaceIndexInit,
    /// \brief Initialize a CM SamplerIndex from an integer.
...
public:
  ...
  /// \brief Add a step to initialize a CM vector/matrix from a constant array.
  void AddCMVectorMatrixInitStep(QualType T);

  /// \brief Add a step to initialize a CM SurfaceIndex from an integer.
  void AddCMSurfaceIndexInitStep(QualType T);

  /// \brief Add a step to initialize a CM SamplerIndex from an integer.
