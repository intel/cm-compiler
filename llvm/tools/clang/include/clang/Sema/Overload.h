...
namespace clang {
  ...
  enum ImplicitConversionKind {
    ...
    ICK_CMVectorMatrix_Conversion, ///< CM vector-matrix conversions
    ICK_CMBaseToReference,         ///< CM base to reference type conversions
    ICK_CMReferenceToBase,         ///< CM reference type to base conversions
    ICK_CMVectorMatrix_Splat,      ///< A CM vector/matrix splat
