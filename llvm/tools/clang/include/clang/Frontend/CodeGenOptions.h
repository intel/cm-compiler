...
public:
  ...
  /// For MDF CM compilations, the base name for GenX assembly files, as
  /// specified by the /Fa driver option. This has to be handled as a special
  /// case as the kernel assembly file names are embedded within the generated
  /// .isa file.
