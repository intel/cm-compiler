...
#else
#include <float.h>
// Disable pragma with ICL
#pragma fenv_access (on)
// FIXME Do we need fp mode precise
#endif
#endif
...
template <typename RT, typename T, uint SZ>
CM_API extern RT
cm_pack_mask(const stream<T,SZ>& src0) {
    // static const bool conformable1 = check_true<dwordtype<RT>::value && !uinttype<RT>::value>::value;
    static const bool conformable1 = dwordtype<RT>::value;
    static const bool conformable2 = is_ushort_type<T>::value;
    static const bool conformable3 = check_true< SZ == 8 || SZ == 16 || SZ == 32>::value;
...
template <typename RT, typename T, uint SZ>
CM_API extern vector<RT,SZ> 
cm_unpack_mask(const T& src0) {
    // static const bool conformable1 = check_true<dwordtype<T>::value && !uinttype<T>::value>::value;
    static const bool conformable1 = dwordtype<T>::value;
    static const bool conformable2 = is_ushort_type<RT>::value;
    static const bool conformable3 = check_true< SZ == 8 || SZ == 16 || SZ == 32>::value;
