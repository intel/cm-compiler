/**             
*** -----------------------------------------------------------------------------------------------
*** cvs_id[] = "$Id: cm_def.h 25899 2011-08-05 18:44:07Z kchen24 $"
*** -----------------------------------------------------------------------------------------------
***
...
***                      
***
*** Description: This header contain definition of Cm fundamental data types & templates
***
*** -----------------------------------------------------------------------------------------------
**/
...
#if !defined(__CLANG_CM) && !defined(CM_EMU) && defined(_WIN32) && (_MSC_VER >= 1800)
// Workaround for VS2013 type traits  - these are not supported by icl
// so we force them all to false here, and rely on clang-cm to catch any
// use of them that would result in errors.
