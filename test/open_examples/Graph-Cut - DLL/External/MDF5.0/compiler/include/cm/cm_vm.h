/**             
*** -----------------------------------------------------------------------------------------------
*** cvs_id[] = "$Id: cm_vm.h 26012 2011-09-14 23:39:05Z zliu11 $"
*** -----------------------------------------------------------------------------------------------
***
...
***                      
***
*** Description: Cm vector/matrix template classes
***
*** -----------------------------------------------------------------------------------------------
**/
...
#include <assert.h>
#if defined(__CM) && !defined(__GNUC__) // Change the include files used for icl compile
#include <stdio.h> // We require printf to be declared for icl (although not used)
#include <new> // We need to explicitly include this header so placement 'new' works
#else
#include <iostream>
#include <string>
#include <string.h>
