...
// The /Qxcm_inst_compaction option is ignored
// RUN: %cmc -mCM_old_asm_name /Qxcm_inst_compaction %w 2>&1 | FileCheck %w 
// RUN: rm %W.isa
...
// CHECK: cm_inst_compaction_slash.cpp(15,2):  warning: CM_GENX not defined [-W#warnings]
