...
// The /Qxcm_forcefirstfit option is ignored
// RUN: %cmc -mCM_old_asm_name /Qxcm_forcefirstfit %w 2>&1 | FileCheck %w 
// RUN: rm %W.isa
...
// CHECK: cm_forcefirstfit_slash.cpp(15,2):  warning: CM_GENX not defined [-W#warnings]
