...
// RUN: %cmc -mCM_printfargs -mCM_old_asm_name -mdump_asm -Qxcm_jit_target=SKL %w 2>&1 | FileCheck %w
...
// RUN: %cmc -mCM_printfargs -mCM_old_asm_name -mdump_asm -Qxcm_jit_target=SKL -Wno-deprecated %w 2>&1 | FileCheck --check-prefix=NOWARN %w
// RUN: rm %W_0.dat %W_0.visaasm %W_0.asm %W.isa
//
